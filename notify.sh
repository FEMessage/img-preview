...
git remote add github https://$GITHUB_TOKEN@github.com/FEMessage/img-preview.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/FEMessage/img-preview/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "img-preview更新", "text": "@所有人\n# [img-preview('$version')]('$html_url')\n'$body'"}}'
